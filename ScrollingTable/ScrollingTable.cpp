...
// ScrollingTable.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CScrollingTableApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CScrollingTableApp::OnAppAbout)
...
// Создание CScrollingTableApp

CScrollingTableApp::CScrollingTableApp() noexcept
{
	...
	SetAppID(_T("ScrollingTable.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CScrollingTableApp

CScrollingTableApp theApp;


// Инициализация CScrollingTableApp

BOOL CScrollingTableApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CScrollingTableDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CScrollingTableView));
	if (!pDocTemplate)
		return FALSE;
...
int CScrollingTableApp::ExitInstance()
{
...
// Обработчики сообщений CScrollingTableApp
...
void CScrollingTableApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
